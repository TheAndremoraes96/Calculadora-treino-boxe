...
⚠️ Observação:
Essas são sugestões básicas para organização alimentar.
Para dieta clínica ou restrição de saúde, procure um nutricionista.
`;
}
...
function atualizarTema(objetivo) {
    ...
    if (objetivo === "hipertrofia") {
        body.classList.add("tema-hipertrofia");
        body.style.background = "#071a2d";
        body.style.color = "#d8ecff";
    }

    if (objetivo === "emagrecimento") {
        body.classList.add("tema-emagrecimento");
        body.style.background = "#2b0909";
        body.style.color = "#ffe0e0";
    }

    if (objetivo === "manutencao") {
        body.classList.add("tema-manutencao");
        body.style.background = "#082b18";
        body.style.color = "#dcffe8";
    }
}
